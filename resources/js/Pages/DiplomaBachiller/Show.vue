<template>
  <Head :title="`Diploma de Bachiller - ${diploma.persona?.nombres ?? ''} ${diploma.persona?.paterno ?? ''}`" />
  <div class="space-y-6">
      ...
      <div class="space-y-6">
        ...
        <Card>
          ...
          <CardContent class="space-y-3">
            ...
            <div v-if="diploma.updated_at && diploma.updated_at !== diploma.created_at" class="grid grid-cols-2 gap-4">
              <div>
          ...
          <CardContent>
            <div v-if="diploma.file_dir" class="space-y-4">
              ...
              <div class="flex justify-center">
                <Button variant="outline" as="a" :href="route('diploma-bachiller.pdf', diploma.id)" download>
    ...
    <AlertDialogContent>
      <AlertDialogHeader>
        ...
        <AlertDialogDescription>
          Esta acción no se puede deshacer. Se eliminará permanentemente el diploma de
...
defineOptions({
  layout: (h: any, page: any) => h(AppLayout, {
    title: 'Detalle de Diploma de Bachiller',
    pageTitle: 'Detalle de Diploma de Bachiller',
    navTabs,
    activeTab: 'lista'
  }, () => page)
})
...
const deleteDiploma = () => {
  ...
  router.delete(route('diploma-bachiller.destroy', props.diploma.id), {
    ...
    onError: () => {
      toast.error('No se pudo eliminar el diploma.')
    }
  })
}
</script>
