    ...
    <div class="space-y-6">
      ...
      <div class="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent>
            <div class="flex items-center justify-between p-4 bg-blue-50 dark:bg-blue-950 rounded-lg">
              <div>
        ...
        <CardHeader>
          <div class="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Lista de carreras que pertenecen a esta facultad
              </CardDescription>
            </div>
            <Button as-child>
        ...
        <CardContent>
            ...
            <Table>
              ...
              <TableBody>
                <TableRow v-for="carrera in facultad.carreras" :key="carrera.id">
                  ...
                  <TableCell>
                    <Link 
                      :href="route('v2.carreras.show', carrera.id)"
          ...
          <div v-else class="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p class="text-muted-foreground mb-6">
              Esta facultad aún no tiene carreras. Crea la primera carrera para comenzar.
            </p>
            <Button as-child>
              <Link :href="route('v2.carreras.create', { facultad_id: facultad.id })">
                <Icon icon="mdi:plus" class="h-4 w-4 mr-2" />
