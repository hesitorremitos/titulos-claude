<template>
    <AppLayout
        ...
        :breadcrumbs="[{ label: 'Carreras', href: route('v2.carreras.index') }, { label: carrera.programa }]"
    >
        <div class="space-y-6">
            <!-- Header -->
            <div class="border-b border-border pb-4">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p class="text-muted-foreground">Información detallada de la carrera académica</p>
                    </div>
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                        Esta acción no se puede deshacer. Se eliminará permanentemente la carrera "{{ carrera.programa }}" ({{
                                            carrera.id
                                        }}).
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle class="flex items-center gap-2"> Información Básica </CardTitle>
                    </CardHeader>
                        ...
                        <div class="rounded-lg bg-blue-50 p-4 dark:bg-blue-950">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p v-if="carrera.facultad.direccion" class="mt-1 text-sm text-blue-600 dark:text-blue-400">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription> Operaciones comunes para esta carrera </CardDescription>
                </CardHeader>
                <CardContent>
