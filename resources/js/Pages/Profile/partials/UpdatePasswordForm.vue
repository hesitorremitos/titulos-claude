  ...
  <Card>
    <CardHeader>
      <CardTitle class="flex items-center">
        <Icon icon="material-symbols:lock" class="w-5 h-5 mr-2 text-orange-600" />
        Cambiar Contraseña
      </CardTitle>
      <CardDescription>
      ...
      <form @submit.prevent="submit" class="space-y-4">
        ...
        <div class="space-y-2">
          <Label for="current_password" class="flex items-center">
            <Icon icon="material-symbols:lock-open" class="w-4 h-4 mr-1" />
            Contraseña Actual
          </Label>
          <Input
            id="current_password"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="space-y-2">
            <Label for="password" class="flex items-center">
              <Icon icon="material-symbols:key" class="w-4 h-4 mr-1" />
              Nueva Contraseña
            </Label>
            <Input
              id="password"
          ...
          <div class="space-y-2">
            <Label for="password_confirmation" class="flex items-center">
              <Icon icon="material-symbols:check-circle" class="w-4 h-4 mr-1" />
              Confirmar Contraseña
            </Label>
            <Input
        ...
        <div class="flex justify-end pt-4">
          <Button type="submit" variant="secondary" :disabled="form.processing">
            ...
            <Icon v-else icon="material-symbols:key" class="w-4 h-4 mr-2" />
