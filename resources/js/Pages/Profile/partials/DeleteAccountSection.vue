    ...
    <Card class="border-destructive/50">
        <CardHeader>
            <CardTitle class="flex items-center text-destructive">
                <Icon icon="material-symbols:cancel" class="mr-2 h-5 w-5" />
                Eliminar Cuenta
            </CardTitle>
            <CardDescription>
                Una vez eliminada tu cuenta, todos sus recursos y datos serán eliminados permanentemente. Antes de eliminar tu cuenta, descarga
                cualquier dato o información que desees conservar.
            </CardDescription>
        </CardHeader>

        <CardContent>
            <div class="rounded-md border border-destructive/10 bg-destructive/5 p-4">
                <div class="flex items-start">
                    <Icon icon="material-symbols:info" class="mt-0.5 mr-3 h-5 w-5 flex-shrink-0 text-destructive" />
                    <div class="flex-1">
                        <h4 class="text-sm font-medium text-destructive">Advertencia sobre la eliminación de cuenta</h4>
                ...
                <AlertDialog :open="confirmingUserDeletion" @update:open="confirmingUserDeletion = $event">
                    <AlertDialogTrigger as-child>
                        <Button variant="destructive" @click="confirmUserDeletion">
                            <Icon icon="material-symbols:person-remove" class="mr-2 h-4 w-4" />
                            Eliminar Cuenta
                        </Button>
                    </AlertDialogTrigger>
                    ...
                    <AlertDialogContent>
                        ...
                        <AlertDialogFooter>
                            <AlertDialogCancel @click="confirmingUserDeletion = false"> Cancelar </AlertDialogCancel>
                            <AlertDialogAction
                                @click="deleteUser"
