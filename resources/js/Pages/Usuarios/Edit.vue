<template>
    <AppLayout title="Editar Usuario" :breadcrumbs="[{ label: 'Usuarios', href: route('v2.usuarios.index') }, { label: 'Editar Usuario' }]">
        <div class="space-y-6">
            <!-- Header -->
                    ...
                    <CardContent class="pt-6">
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="border-t border-border pt-6">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-sm text-muted-foreground">
                                            La contraseña actual se mantendrá si no se especifica una nueva
                                        </p>
                                    </div>
                                    <Button 
                                        type="button" 
                                ...
                                <div v-if="showPasswordReset" class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <!-- Nueva Contraseña -->
                                    <div class="space-y-2">
