<template>
  <Head title="Registrar Título Provisional Nacional" />
    <div class="space-y-6">
                ...
                <CardContent class="space-y-4">
                  <div class="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        id="nro_documento"
                        v-model="tituloStore.nro_documento"
                        type="number"
                  ...
                  <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input 
                        id="fecha_emision" 
                        v-model="tituloStore.fecha_emision" 
                        type="date"
                  ...
                  <div>
                    ...
                    <Input 
                      id="observaciones" 
                      v-model="tituloStore.observaciones" 
                      type="text"
...
defineOptions({
  layout: (h: any, page: any) => h(AppLayout, {
    title: 'Registrar Título Provisional Nacional',
    pageTitle: 'Registrar Título Provisional Nacional',
    navTabs: navTabs,
    activeTab: 'registrar'
  }, () => page)
})
...
// Props tipadas
const props = defineProps<TituloProvisionNacionalPageProps>()

// Stores
const personalDataStore = usePersonalDataStore()
const tituloStore = useTituloProvisionNacionalStore()
...
const updateFormData = () => {
  form.clearErrors()
  Object.assign(form, tituloStore.formData)
}
