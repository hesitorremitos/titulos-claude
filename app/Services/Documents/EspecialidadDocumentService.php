...
class EspecialidadDocumentService
{
    ...
    {
        $gestion = $this->sanitizeGestion($context['gestion'] ?? null);
        $mencion = $this->sanitizeSegment($context['mencion'] ?? null, 'sin-mencion');

        return "especialidades/{$gestion}/{$mencion}";
    }
    ...
    private function sanitizeGestion(?int $gestion): string
    {
